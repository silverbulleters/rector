...
Процедура ВыполнитьПриложение()
	...
	КонсольноеПриложение.Опция("U ib-user ib-usr db-user", "", "пользователь информационной базы")
					.ТСтрока()
					.ВОкружении("PREPARE_BASE_USR PREPARE_BASE_USER");

	КонсольноеПриложение.Опция("P ib-pwd db-pwd", "", "пароль пользователя информационной базы")
					.ТСтрока()
					.ВОкружении("PREPARE_BASE_PASSWORD PREPARE_BASE_PWD");
	
	КонсольноеПриложение.Опция("C ib-connection ibconnection", "", "путь подключения к информационной базе")
					.ТСтрока()
